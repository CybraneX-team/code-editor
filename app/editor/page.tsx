    ...
    useEffect(()=>{
      ...
      return (
          ...
          <div className="flex flex-row items-center">
            ...
            <div>
              <button className="bg-blue-800 px-5 py-2 rounded-md">Save</button>
            </div>
          </div>
          <div className="space-x-4 w-full items-start px-4 py-4">
            ...
            <div className="right-container flex flex-shrink-0 w-full flex-row">
              <OutputWindow outputDetails={outputDetails} />
              <div className="flex flex-column w-full items-end">
                <CustomInput
